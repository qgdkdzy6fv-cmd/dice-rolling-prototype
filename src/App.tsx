            ...
            <div key={d.type} className="relative">
              <button
                ...
                className={`
                  ...
                  ${d.selected
                    ? 'bg-emerald-500 border-emerald-400 shadow-lg shadow-emerald-500/50 scale-105'
              ...
              >
                <div className="text-center">
                  ...
                  {d.result !== null && (
                    <>
                      <div className={`text-sm mb-1 ${d.selected ? 'text-emerald-100' : 'text-slate-400'}`}>
                        {d.rolls.length > 1 ? `[${d.rolls.join(' + ')}]` : d.rolls[0]}
                        {d.modifier !== 0 && (
                          <span className={d.modifier > 0 ? 'text-emerald-300' : 'text-red-300'}>
                      ...
                      <div className={`
                        ...
                        ${d.selected ? 'text-white' : 'text-emerald-400'}
                      `}>
                        {d.result}
                      </div>
                    </>
                  ...
                  {d.selected && d.result === null && (
                    <div className="text-sm text-emerald-100 mt-2">Selected</div>
                  )}
                </div>
              </button>
